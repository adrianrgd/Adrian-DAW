...
CREATE TABLE `hotel` (
  ...
  `codigoPostalHotel` varchar(5)  NOT NULL,
  `poblacionHotel` varchar(25)  NOT NULL,
  `provinciaHotel` varchar(25)  NOT NULL,
  `telefonoHotel` varchar(12)  NOT NULL,
  `categoriaHotel` enum('1','2','3','4','5','6','7')  NOT NULL
) ;
...
(8, 'Hostal Vera', 'Carrer del Ravalet, 2', '46240', 'Carlet', 'Valencia', '962 53 24 36', '1'),
...
ALTER TABLE `habitacion`
  ADD CONSTRAINT `habitacion_hotel` FOREIGN KEY (`idHotel`) REFERENCES `hotel` (`idHotel`) ON UPDATE CASCADE;
